...
"""
--dataset-path '/home/dorian/workspace/ML_toolkit/src/model/computer_vision/data/256_ObjectCategories' --train-size 0.7 --validation-size 0.2 --test-size 0.1 --train 1 --debug 1 
"""
...
try:
    ...
    classes = cd_1.labels.extend({0: 'ambiguous'})
    ...
    vgg_1 = Vgg(classes, batch_size=2, height=1200, width=800, dim_out=len(classes),
                ...
                is_encoder=True, validation_size=10, logger=logger)
